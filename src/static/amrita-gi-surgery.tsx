  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "350",
          image: "/images/amrita/Dr20Dhar.webp",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "290",
          image: "/images/amrita/Dr20Naik.webp",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                              ...
                              <div className="space-y-4">
                                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                                      ...
                                      <div>
                                          <div className="font-semibold text-gray-900">
                                              55 minutes from Cochin Airport
                                          </div>
                                  ...
                                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                                      ...
                                      <div>
                                          ...
                                          <div className="text-sm text-gray-600">
                                              Old Faridabad Metro Connectivity
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Amrita GI Surgery Center of Excellence offers
                                  world-class gastrointestinal surgical care
                                  with cutting-edge technology and
                              ...
                              <p>
                                  ...
                                  internationally trained specialists who
                                  perform both routine and complex GI surgeries
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919846789123?text=Hi, I'd like to know more about ${treatment.name} at Amrita Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • World-class GI surgery with cutting-edge
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919846789123?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919846789123?text=Hi, I want to book an appointment for GI surgery consultation at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919846789123?text=Hi, I need a cost estimate for GI surgery at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+919846789123", "_blank")
                                  }>
