  ...
  const doctors = [
      {
          ...
          rating: "4.8",
          reviews: "445",
          image: "/images/sarvodaya/DR_DINESH_PENDHARKAR_80ebd57089.png",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "378",
          image: "/images/sarvodaya/small_dr_vishnu_394036c8eb.jpeg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  ...
                                  medical technology, personalized treatment
                                  approaches, and dedicated patient support.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1587010580103-fd86b8ea14ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwb25jb2xvZ3klMjBlcXVpcG1lbnQlMkMlMjBlbXBoYXNpemluZyUyMHByZWNpc2lvbiUyMHRyZWF0bWVudC58ZW58MHx8fHwxNzU3NTk1MjQ3fDA&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Sarvodaya Cancer Institute is a comprehensive
                                  cancer care center offering advanced surgical,
                                  medical, and radiation oncology services with
                                  personalized treatment approaches and
                                  compassionate care.
                              </p>
                              <p>
                                  Our dedicated team of oncologists and
                                  state-of-the-art technology provide
                                  compassionate, evidence-based treatment plans
                                  with exceptional patient outcomes and
                                  comprehensive support throughout the treatment
                                  journey.
                              </p>
                          </div>
                      </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "consultation" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          treatment planning with personalized
                                          care approaches.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          targeted treatments with comprehensive
                                          medical technology.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "recovery" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          rehabilitation programs with dedicated
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/911126518271?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/911126518271?text=Hi, I'd like to book an appointment with ${doctor.name} for oncology consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911126518271?text=Hi, I want to book an appointment for oncology consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911126518271?text=Hi, I need a cost estimate for cancer treatment at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>14+ other people</strong> are
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          oncology@sarvodayahospital.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+911126518271", "_blank")
                                  }>
