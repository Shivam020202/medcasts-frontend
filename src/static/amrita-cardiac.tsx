  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "385",
          image: "/images/amrita/dr-ashish-kumar-img.webp",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "312",
          image: "/images/amrita/Dr20Katewa.webp",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Leading cardiac care with advanced medical
                                  technology, holistic healing approaches, and
                                  dedicated heart specialists.
                              </p>
                          </div>
                              ...
                              <div className="space-y-4">
                                  ...
                                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                                      ...
                                      <div>
                                          ...
                                          <div className="text-sm text-gray-600">
                                              Old Faridabad Metro Connection
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Amrita Hospital's Institute of Cardiovascular
                                  Sciences combines cutting-edge medical
                                  technology with holistic healing approaches,
                                  offering comprehensive cardiac care for all
                                  heart conditions.
                              </p>
                              <p>
                                  Our dedicated team of cardiologists and
                                  cardiac surgeons provide world-class treatment
                                  with advanced cardiac catheterization labs,
                                  state-of-the-art equipment, and compassionate
                                  care in a spiritually nurturing environment.
                              </p>
                          </div>
                      </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "recovery" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          lifestyle counseling, and holistic
                                          recovery programs with spiritual
                                          support.
                                      </div>
                                  )}
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/914842801234?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/914842801234?text=Hi, I want to book an appointment for cardiac consultation at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/914842801234?text=Hi, I need a cost estimate for cardiac treatment at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
