...
const SarvodayaCardiacService = () => {
  ...
  const doctors = [
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "320",
          image: "/images/sarvodaya/small_Dr_Ranjan_For_Website_99b8763a06.jpg",
          qualifications:
              "MBBS, MD, DM Cardiology, Fellowship in Electrophysiology",
          expertise: [
              "Electrophysiology",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "290",
          image: "/images/sarvodaya/DR_AMIT_KUMAR_43c1f07ce1.png",
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Leading cardiac care institution with advanced
                                  technology, compassionate specialists, and
                                  holistic approach to heart care at affordable
                                  costs.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1664902265139-934219cee42f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwY2FyZGlhYyUyMGVxdWlwbWVudCUyQyUyMGxpa2VseSUyMGluJTIwYSUyMG1lZGljYWwlMjBvciUyMGhvc3BpdGFsJTIwc2V0dGluZy58ZW58MHx8fHwxNzU3NTk1MTg0fDA&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  ...
                                  of Cardiovascular Sciences combines advanced
                                  medical technology with compassionate care,
                                  providing world-class cardiac treatment at
                                  affordable costs.
                              </p>
                              <p>
                                  Our cardiac department is equipped with
                                  state-of-the-art facilities, advanced cardiac
                                  catheterization labs, and a team of highly
                                  skilled cardiac specialists performing both
                                  routine and complex cardiac procedures with
                                  excellent outcomes.
                              </p>
                          </div>
                      </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          minimally invasive and complex
                                          surgeries with advanced technology and
                                          compassionate care.
                                      </div>
                                  )}
                              </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced cardiac care with cutting-edge
                                      technology and compassionate team
                                  </li>
                                  <li>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919811456789?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                                  ...
                                  <ul className="space-y-2 text-gray-700 text-sm">
                                      ...
                                      <li>
                                          • Bring all medical records, ECG
                                          reports, and previous cardiac imaging
                                      </li>
                                      <li>
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I want to book an appointment for cardiac consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I need a cost estimate for cardiac surgery at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $130/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  ...
                                  response team and comprehensive cardiac care
                              </p>
                              <button
