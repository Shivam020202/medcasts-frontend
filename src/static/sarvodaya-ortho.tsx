...
const SarvodayaOrthoService = () => {
  ...
  const doctors = [
      {
          name: "Dr. Pankaj Walecha",
          specialization: "Director & Head - Hip & Robotic Knee Replacement",
          experience: "20+ years",
          patientsTreated: "3,500+",
          rating: "4.8",
          reviews: "150+",
          image: "/images/small_Dr_Pankaj_9073a6b9b0.jpg",
          qualifications:
              "MS (Orthopaedics), Fellow Hip & Knee Surgery (UK, S. Korea, Germany)",
          expertise: [
      ...
      {
          name: "Prof. Dr. Ankit Kedia",
          specialization: "HOD - Orthopedics & Joint Replacement",
          experience: "18+ years",
          patientsTreated: "2,900+",
          rating: "4.7",
          reviews: "113+",
          image: "/images/small_PROF_DR_ANKIT_KEDIA_ea57d0efa7.jpg",
          qualifications: "MBBS, MS (Orthopaedics), Fellowship",
          expertise: [
              "Joint Replacement",
              "Complex Trauma",
      ...
      },
      {
          ...
          specialization: "Senior Consultant - Orthopaedics & Spine Surgery",
          experience: "15+ years",
          patientsTreated: "2,100+",
          rating: "4.6",
          reviews: "87+",
          image: "/images/DR_ASHISH_TOMAR_955d761ce7.png",
      ...
      {
          name: "Dr. (Maj.) Mukesh Garg",
          specialization: "Senior Consultant - Orthopaedics & Arthroscopy",
          experience: "19+ years",
          patientsTreated: "1,800+",
          rating: "4.7",
          reviews: "72+",
          image: "/images/DR_MAJ_MUKESH_GARG_02cef7ea70.jpg",
          qualifications: "MBBS, MS (Orthopaedics), Fellowship Arthroscopy",
          expertise: ["Arthroscopy", "Sports Injuries", "General Orthopaedics"],

          hospital: "Sarvodaya Hospital",
      },
      {
          name: "Dr. Somesh Virmani",
          specialization: "Associate Director & Head - Paediatric Orthopaedics",
          experience: "14+ years",
          patientsTreated: "1,400+",
          rating: "4.6",
          reviews: "64+",
          image: "/images/DR_SOMESH_VIRMANI_0fbcc99d87.jpg",
          qualifications: "MBBS, MS (Ortho), Fellowship Paediatrics Ortho",
          expertise: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1742234857006-ceaba909665c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwb2YlMjBhJTIwcGVyc29uJTI3cyUyMGZhY2UlMkMlMjBmb2N1c2luZyUyMG9uJTIwdGhlJTIwZmFjaWFsJTIwZmVhdHVyZXMufGVufDB8fHx8MTc1NzUxODkxNnww&ixlib=rb-4.1.0&q=80&w=200$w=100",
    date: "Nov 2024",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Comprehensive orthopedic care with advanced
                                  technology and compassionate service for all
                                  your musculoskeletal needs.
                              </p>
                          </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Sarvodaya Hospital's Orthopaedics Department
                                  offers comprehensive care with
                                  state-of-the-art technology and a team of
                                  highly skilled specialists dedicated to
                                  treating all musculoskeletal conditions.
                              </p>
                              <p>
                                  Our commitment to compassionate healthcare and
                                  advanced surgical techniques ensures optimal
                                  outcomes for patients seeking orthopedic
                                  treatment, from routine procedures to complex
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/911294142000?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/911294142000?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                                  ...
                                  <p className="text-teal-700 text-sm mb-3">
                                      Advanced orthopedic procedures require
                                      comprehensive travel insurance covering
                                      surgical procedures, personal accidents,
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911294142000?text=Hi, I want to book an appointment for orthopedic consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911294142000?text=Hi, I need a cost estimate for orthopedic treatment at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>5+ other people</strong> are
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  ...
                                  advanced trauma care and immediate response
                                  team
                              </p>
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+911294142000", "_blank")
                                  }>
