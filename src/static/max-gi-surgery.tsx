  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "380",
          image: "/images/max/small_Dr_Vikas_4919a739c9.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "260",
          image: "/images/max/small_Dr_20_Ranjeev_20_20_High_20_Res_ec78a10aa1.jpg",
          qualifications:
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "230",
          image: "/images/max/small_Dr_Vivek_Raj_a508d662e7.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "210",
          image: "/images/max/small_Dr_Kaushal_Madan_ab58ff7668 (1).jpeg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Max Super Speciality Hospital GI Surgery
                                  Center of Excellence offers world-class
                                  gastrointestinal surgical care with
                                  cutting-edge technology and internationally
                                  trained specialists providing comprehensive
                                  treatment at affordable costs.
                              </p>
                              <p>
                                  Our Institute of Minimal Access, Metabolic &
                                  Bariatric Surgery is equipped with the latest
                                  technology including robotic surgical systems
                                  and staffed by internationally trained
                                  specialists who perform both routine and
                                  complex GI surgeries with excellent outcomes.
                              </p>
                          </div>
                      </div>
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919811789456?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919811789456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811789456?text=Hi, I want to book an appointment for GI surgery consultation at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811789456?text=Hi, I need a cost estimate for GI surgery at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+919811789456", "_blank")
                                  }>
