  ...
  const doctors = [
      {
          ...
          rating: "4.8",
          reviews: "260",
          image: "/images/amrita/DR_DINESH_PENDHARKAR_80ebd57089.png",
          qualifications:
              "MBBS, MD, DM Clinical Hematology, Fellowship BMT (USA)",
          expertise: [
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "240",
          image: "/images/amrita/DR_ABHISHEK_RAJ_73722147a5.jpg",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "190",
          image: "/images/amrita/small_dr_vishnu_394036c8eb.jpeg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Advanced BMT facility with cutting-edge stem
                                  cell therapies and comprehensive hematological
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1576669801838-1b1c52121e6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwQk1UJTIwdGVjaG5vbG9neSUyQyUyMGZlYXR1cmluZyUyMGElMjBsYWJvcmF0b3J5JTIwb3IlMjBtZWRpY2FsJTIwZXF1aXBtZW50JTIwc2V0dXAufGVufDB8fHx8MTc1NzU5NTIwMHww&ixlib=rb-4.1.0&q=80&w=200$w=400"
                          ...
                          <div className="grid md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="bg-gray-100 rounded-lg p-4">
                                  ...
                                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                                      <iframe
                                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7021.421579636364!2d77.32701639357907!3d28.36759210000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cdc86f7e855a9%3A0xdcdcb7b847e735dc!2sSarvodaya%20Hospital%2C%20Sec%208%20Faridabad!5e0!3m2!1sen!2sin!4v1757500343525!5m2!1sen!2sin"
                                          width="100%"
                                          height="200"
                                          style={{ border: 0 }}
                                          allowFullScreen=""
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Sarvodaya Hospital & Research Centre BMT
                                  Center of Excellence offers advanced BMT
                                  facility with cutting-edge stem cell therapies
                                  and comprehensive hematological care at
                                  affordable costs with experienced specialists.
                              </p>
                              <p>
                                  The BMT unit features HEPA-filtered rooms,
                                  state-of-the-art monitoring systems, and a
                                  specialized team trained in managing
                                  transplant patients with over 1,200 successful
                                  procedures and outcomes matching international
                                  benchmarks.
                              </p>
                          </div>
                      </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4">
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "consultation" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          Comprehensive evaluation, HLA typing,
                                          donor matching, and pre-transplant
                                          conditioning with experienced
                                          hematologists.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          procedures including autologous,
                                          allogeneic, and immunotherapy with
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "recovery" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          Comprehensive post-transplant
                                          monitoring, infection prevention, and
                                          long-term follow-up care with advanced
                                          monitoring systems.
                                      </div>
                                  )}
                              </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919810123456?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced BMT care with cutting-edge stem
                                      cell therapies and expert team
                                  </li>
                                  <li>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      Experienced BMT specialists with proven
                                      expertise
                                  </p>
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                                  ...
                                  <p className="text-teal-700 text-sm mb-3">
                                      BMT procedures require comprehensive
                                      travel insurance covering transplant
                              ...
                              <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                                  ...
                                  <ul className="space-y-2 text-gray-700 text-sm">
                                      <li>
                                          • Patients must arrive at least 1 week
                                          before transplant for pre-conditioning
                                      </li>
                                      <li>
                                          • Bring all medical records, previous
                                          treatment history, and donor
                                          information
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                          • Family member/caregiver must
                                          accompany patient throughout treatment
                                      </li>
                                      <li>
                                          • Plan for 2-3 months stay in India
                                          for complete treatment and recovery
                                      </li>
                                  </ul>
                              </div>
                              ...
                              <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                                  ...
                                  <div className="text-amber-700 text-sm space-y-2">
                                      <p>
                                          • For BMT scheduled within 30 days,
                                          full payment is required
                                      </p>
                                      <p>
                                          • For BMT beyond 30 days, 50% advance
                                          payment to confirm booking
                                      </p>
                                      <p>
                                          • Cancellations 15+ days before
                                          treatment: 50% refund (excluding
                                          booking fee)
                                      </p>
                                      <p>
                              ...
                              <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                                  <h3 className="font-bold text-blue-800 mb-3">
                                      Why Choose MedCasts with Sarvodaya
                                  </h3>
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I want to book an appointment for BMT consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I need a cost estimate for BMT at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>8+ other people</strong> are
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $700/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  24/7 emergency BMT services with immediate
                                  response team and comprehensive transplant
                                  care
                              </p>
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+919810123456", "_blank")
                                  }>
