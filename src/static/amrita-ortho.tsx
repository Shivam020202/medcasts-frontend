...
const AmritaOrthoService = () => {
  ...
  const doctors = [
      {
          name: "Dr. Pritish Singh",
          specialization: "Orthopaedics and Joint Replacement",
          experience: "26+ years",
          patientsTreated: "3,800+",
          rating: "4.9",
          reviews: "205",
          image: "/images/dr-pritish-singh-amrita-hospital-faridabad.webp",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "167",
          image: "/images/dr-sahil-gaba.webp",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Holistic orthopedic care combining advanced
                                  medical technology with compassionate healing
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  ...
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="\images\ortho\Pediatric-Care.png"
                                          alt="Pediatric Care"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Amrita Hospital's Orthopaedics Department
                                  combines cutting-edge medical technology with
                                  holistic healing approaches, offering
                                  comprehensive care for all age groups
                                  including specialized pediatric orthopedics.
                              </p>
                              <p>
                                  Our unique approach integrates modern surgical
                                  techniques with traditional healing practices,
                                  providing patients with a complete mind-body
                                  healing experience in a spiritually nurturing
                                  environment.
                              </p>
                          </div>
                      </div>
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/914842801234?text=Hi, I'd like to know more about ${treatment.name} at Amrita Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="grid md:grid-cols-3 gap-6">
                              ...
                              <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                                  ...
                                  <ul className="text-teal-700 space-y-2 text-sm">
                                      <li>
                                          • Minimally invasive operation theater
                                      </li>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/914842801234?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                                  ...
                                  <p className="text-teal-700 text-sm mb-3">
                                      Holistic orthopedic procedures require
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/914842801234?text=Hi, I want to book an appointment for orthopedic consultation at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/914842801234?text=Hi, I need a cost estimate for orthopedic treatment at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $210/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  ...
                                  holistic care approach and immediate response
                                  team
                              </p>
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+914842801234", "_blank")
                                  }>
