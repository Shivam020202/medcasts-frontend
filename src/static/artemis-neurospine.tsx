  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "350",
          image: "/images/Artemis Hospital/dr-dr-aditya-gupta.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "280",
          image: "/images/Artemis Hospital/dr-dr-pawan-goyal.jpg",
          qualifications:
              "MBBS, MS, MCh (Neurosurgery), Fellowship in Skull Base Surgery",
          expertise: [
              "Skull Base Surgery",
              "Neuro-oncology",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "220",
          image: "/images/Artemis Hospital/dr-dr-sk-rajan.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "190",
          image: "/images/Artemis Hospital/dr-dr-sanjeev-srivastava.jpg",
          qualifications:
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                  ...
                                  <div className="absolute bottom-4 left-4 text-white">
                                      ...
                                      <p className="text-sm opacity-90">
                                          Neurospine Center of Excellence
                                      </p>
                                  </div>
                              </div>
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1757152962882-6bf8495b324d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Artemis Neurospine Center of Excellence offers
                                  advanced neurosurgery and spine care with
                                  cutting-edge technology and internationally
                              ...
                              <p>
                                  Our Neurospine department is equipped with the
                                  latest technology including intraoperative
                                  neuronavigation, neuromonitoring, and robotic
                                  assistance, allowing our internationally
                                  trained specialists to perform both routine
                                  and complex neurological and spine surgeries
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Artemis Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Comprehensive neurospine care with
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I want to book an appointment for neurospine consultation at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I need a cost estimate for neurospine surgery at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          neurospine@artemishospitals.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
