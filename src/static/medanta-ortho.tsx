  ...
  const doctors = [
      {
          ...
          specialization: "Group Chairman - Orthopaedics",
          experience: "42+ years",
          patientsTreated: "39,000+",
          rating: "4.9",
          reviews: "250+",
          image: "/images/dr-ashok-rajgopal.png",
          qualifications:
              "MBBS, MS (Ortho), M.Ch. (Ortho), F.R.C.S., F.I.M.S.A.",
          expertise: [
      ...
      },
      {
          ...
          specialization: "Vice Chairman - Orthopaedics",
          experience: "32+ years",
          patientsTreated: "5,000+",
          rating: "4.8",
          reviews: "180+",
          image: "/images/dr-attique-vasdev.png",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "165+",
          image: "/images/dr-raman-kant-aggarwal.png",
          qualifications:
              "MBBS, MS (Orthopaedics), MSc (Trauma & Orthopaedics)",
          expertise: [
      ...
      {
          name: "Dr. Vipin Chand Tyagi",
          specialization: "Senior Director - Orthopaedics",
          experience: "25+ years",
          patientsTreated: "3,200+",
          rating: "4.6",
          reviews: "140+",
          image: "/images/dr-vipin-chand-tyagi.png",
          qualifications: "MBBS, D. Ortho, Fellowship in Arthroplasty",
          expertise: [
              "Hip Replacement",
              "Knee Replacement",
              "Revision Surgery",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Multi-specialty orthopedic care with advanced
                                  oncology, pediatric expertise, and
                              ...
                              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                  ...
                                  <div className="absolute bottom-4 left-4 text-white">
                                      ...
                                      <p className="text-sm opacity-90">
                                          Multi-Specialty Orthopaedic Center
                                      </p>
                                  </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                  ...
                                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                                      ...
                                      <div>
                                          ...
                                          <div className="text-sm text-gray-600">
                                              Sector 38, Gurugram - Medical Hub
                                          </div>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Medanta's Orthopaedics Department is a
                                  comprehensive multi-specialty center offering
                                  advanced care for bone tumors, pediatric
                                  conditions, and complex trauma cases.
                              </p>
                              <p>
                                  Our specialized teams in orthopedic oncology,
                                  pediatric orthopedics, and trauma surgery
                                  provide world-class treatment with
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>3+ other people</strong> are
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  24/7 emergency orthopedic and trauma services
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+911244144444", "_blank")
                                  }>
