...
const ArtemisGISurgeryService = () => {
  ...
  const doctors = [
      {
          name: "Dr. M.A Mir",
          specialization: "Head - Gastroenterology",
          experience: "25+ years",
          patientsTreated: "5,000+",
          rating: "4.9",
          reviews: "320",
          image: "/images/Artemis Hospital/dr-dr-m-a-mir.jpg",
      ...
      },
      {
          ...
          specialization: "Sr. Consultant Unit",
          experience: "22+ years",
          patientsTreated: "3,500+",
          rating: "4.8",
          reviews: "280",
          image: "/images/Artemis Hospital/dr-dr-bimal-kumar-sahu.jpg",
          qualifications:
      ...
      },
      {
          ...
          specialization: "Head - Pediatric Gastroenterology",
          experience: "22+ years",
          patientsTreated: "3,500+",
          rating: "4.8",
          reviews: "280",
          image: "/images/Artemis Hospital/dr-dr-sakshi-karkra.jpg",
          qualifications:
              "MBBS, MS, Fellowship in HPB Surgery & Liver Transplantation",
          expertise: [
              "Liver Transplantation",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Advanced gastrointestinal surgical care with
                                  minimally invasive techniques and
                                  comprehensive treatment for digestive system
                                  disorders.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1579684288452-b334934f845f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwR0klMjBzdXJnZXJ5JTIwZXF1aXBtZW50LnxlbnwwfHx8fDE3NTc1OTUyOTd8MA&ixlib=rb-4.1.0&q=80&w=200$w=400"
                                  ...
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="\images\ortho\Minimally-Invasive.png"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Artemis GI Surgery Center of Excellence offers
                                  advanced gastrointestinal surgical care with
                                  minimally invasive techniques and
                                  comprehensive treatment for digestive system
                                  disorders.
                              ...
                              <p>
                                  Our GI surgery department specializes in both
                                  routine and complex procedures, with
                                  particular expertise in minimally invasive
                                  techniques that result in smaller incisions,
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          invasive, laparoscopic, and complex
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919810123456?text=Hi, I'd like to know more about ${treatment.name} at Artemis Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced GI surgery with minimally
                                      invasive techniques and international
                                      expertise
                                  </li>
                                  <li>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I want to book an appointment for GI surgery consultation at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I need a cost estimate for GI surgery at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          gi.surgery@artemishospitals.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
