  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "350",
          image: "/images/medanta/dr-rajesh-puri.png",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "320",
          image: "/images/medanta/dr-amarender-singh-puri.png",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "290",
          image: "/images/medanta/dr-randhir-sud.png",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "260",
          image: "/images/medanta/dr-adarsh-chaudhary.png",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  ...
                                  internationally trained specialists at
                                  affordable costs.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1669930605340-801a0be1f5a3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwR0klMjBzdXJnZXJ5JTIwZXF1aXBtZW50JTJDJTIwZmVhdHVyaW5nJTIwYSUyMGNsZWFuJTIwYW5kJTIwcHJvZmVzc2lvbmFsJTIwc2V0dXAufGVufDB8fHx8MTc1NzU5NTI4MXww&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Medanta - The Medicity GI Surgery Center of
                                  Excellence offers world-class gastrointestinal
                                  surgical care with cutting-edge technology and
                                  internationally trained specialists providing
                                  comprehensive treatment at affordable costs.
                              </p>
                              <p>
                                  Our Institute of Digestive & Hepatobiliary
                                  Sciences is equipped with the latest
                                  technology and staffed by internationally
                                  trained specialists who perform both routine
                                  and complex GI surgeries with excellent
                                  outcomes.
                              </p>
                          </div>
                      </div>
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919811123456?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      Internationally trained GI surgery
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919811123456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811123456?text=Hi, I want to book an appointment for GI surgery consultation at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811123456?text=Hi, I need a cost estimate for GI surgery at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+919811123456", "_blank")
                                  }>
