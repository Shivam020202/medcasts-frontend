  ...
  const doctors = [
      {
          ...
          rating: "4.8",
          reviews: "320",
          image: "/images/max/small_dr_rayaz_ahmed_28e812fb8d.jpeg",
          qualifications:
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "380",
          image: "/images/max/farham-nain.jpg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1738382783566-6278fdb29009?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGElMjBzcGVjaWZpYyUyMHN1YmplY3QlMjBvciUyMHNjZW5lJTJDJTIwZm9jdXNpbmclMjBvbiUyMGl0cyUyMGZlYXR1cmVzLnxlbnwwfHx8fDE3NTc1OTUzMDB8MA&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Max Super Speciality Hospital BMT Center of
                                  Excellence offers advanced BMT facility with
                                  cutting-edge stem cell therapies and
                                  comprehensive hematological care at affordable
                                  costs with internationally trained
                                  specialists.
                              </p>
                              <p>
                                  ...
                                  transplant patients with over 2,800 successful
                                  procedures and outcomes matching global
                                  benchmarks.
                              </p>
                          </div>
                      </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "consultation" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          conditioning with internationally
                                          trained specialists.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          allogeneic, and CAR-T cell therapy
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/918800456789?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced BMT care with cutting-edge
                                      technology and international expertise
                                  </li>
                                  <li>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      Internationally trained BMT specialists
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/918800456789?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800456789?text=Hi, I want to book an appointment for BMT consultation at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800456789?text=Hi, I need a cost estimate for BMT at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>12+ other people</strong> are
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $900/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+918800456789", "_blank")
                                  }>
