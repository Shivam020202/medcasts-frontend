...
const ArtemisBMTService = () => {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1748722145009-6ba2d2c70559?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwb2YlMjBhJTIwZmFjZSUyQyUyMGxpa2VseSUyMGElMjBwb3J0cmFpdCUyQyUyMHdpdGglMjBhJTIwZm9jdXMlMjBvbiUyMHRoZSUyMGZhY2lhbCUyMGZlYXR1cmVzLnxlbnwwfHx8fDE3NTc1OTUxODd8MA&ixlib=rb-4.1.0&q=80&w=200$w=100",
    date: "Nov 2024",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  World-class BMT facility with advanced stem
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Artemis BMT Center of Excellence offers
                                  world-class bone marrow transplant facility
                                  with advanced stem cell therapies and
                                  comprehensive hematological care at affordable
                                  costs with internationally trained
                                  specialists.
                              </p>
                              <p>
                                  Our BMT unit features HEPA-filtered rooms,
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/918800456789?text=Hi, I'd like to know more about ${treatment.name} at Artemis Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800456789?text=Hi, I want to book an appointment for BMT consultation at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800456789?text=Hi, I need a cost estimate for BMT at Artemis Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>10+ other people</strong> are
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          bmt.coordinator@artemishospital.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
