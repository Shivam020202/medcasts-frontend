  ...
  const doctors = [
      {
          ...
          rating: "4.8",
          reviews: "320",
          image: "/images/sarvodaya/kshitiz.jpg",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "240",
          image: "/images/sarvodaya/small_Manoj_87b932621e.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "210",
          image: "/images/sarvodaya/kapil.jpg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                                  GI Surgery Center of{" "}
                                  <span className="text-teal-600">
                                      Excellence
                                  </span>
                              </h1>
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  World-class gastrointestinal surgical care
                                  with cutting-edge technology and experienced
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                  ...
                                  <div className="absolute bottom-4 left-4 text-white">
                                      ...
                                      <p className="text-sm opacity-90">
                                          GI Surgery Center of Excellence
                                      </p>
                                  </div>
                              </div>
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1579684288452-b334934f845f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Sarvodaya Hospital & Research Centre GI
                                  Surgery Center of Excellence offers
                                  world-class gastrointestinal surgical care
                                  with cutting-edge technology and experienced
                                  specialists providing comprehensive treatment
                                  at affordable costs.
                              </p>
                              <p>
                                  Our GI Surgery department is equipped with the
                                  latest technology including advanced
                                  laparoscopic systems and staffed by
                                  experienced specialists who perform both
                                  routine and complex GI surgeries with
                                  excellent outcomes.
                              </p>
                          </div>
                      </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4">
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "consultation" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          Comprehensive GI evaluation, advanced
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          Advanced gastrointestinal surgical
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced GI surgery with cutting-edge
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      Experienced GI surgery specialists with
                                      proven expertise
                                  </p>
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919811456789?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                                  ...
                                  <p className="text-teal-700 text-sm mb-3">
                                      Advanced GI surgical procedures require
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I want to book an appointment for GI surgery consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I need a cost estimate for GI surgery at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          gi.surgery@sarvodayahospital.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  24/7 emergency GI surgery services with
