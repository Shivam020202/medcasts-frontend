...
const MedantaBMTService = () => {
  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "345",
          image: "/images/medanta/dr-manisha-jain.png",
          qualifications:
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "290",
          image: "/images/medanta/dr-anshul-gupta.png",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "310",
          image: "/images/medanta/dr-satya-prakash-yadav.png",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "310",
          image: "/images/medanta/dr-nitin-sood.png",
          qualifications: "MBBS, MD, DM Medical Oncology",
          expertise: ["CAR-T Cell Therapy", "Leukemia", "Lymphoma"],
      },
  ];
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1735835138452-60dad7553022?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwb2YlMjBhJTIwcGVyc29uJTI3cyUyMGZhY2UlMkMlMjBsaWtlbHklMjBhJTIwcG9ydHJhaXQufGVufDB8fHx8MTc1NzU5NTE4MHww&ixlib=rb-4.1.0&q=80&w=200$w=100",
    date: "Nov 2024",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Premier BMT facility with advanced stem cell
                                  therapies and comprehensive hematological care
                                  at affordable costs.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                  <img
                                      src="\images\Medanta hospital.png"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Medanta - The Medicity BMT Center of
                                  Excellence offers premier BMT facility with
                                  advanced stem cell therapies and comprehensive
                                  hematological care at affordable costs with
                              ...
                              <p>
                                  ...
                                  transplant patients with over 3,200 successful
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/918800789456?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • World-class BMT care with advanced stem
                                      cell therapies and international expertise
                                  </li>
                                  <li>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/918800789456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                                  <h3 className="font-bold text-blue-800 mb-3">
                                      Why Choose MedCasts with Medanta
                                  </h3>
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800789456?text=Hi, I want to book an appointment for BMT consultation at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/918800789456?text=Hi, I need a cost estimate for BMT at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>13+ other people</strong> are
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $950/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+918800789456", "_blank")
                                  }>
