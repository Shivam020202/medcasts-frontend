...
const AmritaNeuroSpineService = () => {
  ...
  const doctors = [
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "340",
          image: "/images/amrita/pradeep.webp",
      ...
      {
          name: "Dr. Anandh Balasubramaniam",
          specialization: "Senior Consultant, Spine Surgery",
          experience: "20+ years",
          patientsTreated: "7,200+",
          rating: "4.8",
          reviews: "310",
          image: "/images/amrita/Dr20Balasubramanyam.webp",
          qualifications:
              "MBBS, MS (Ortho), Fellowship in Spine Surgery (Germany)",
          expertise: [
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1757152962882-6bf8495b324d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwbmV1cm9zdXJnZXJ5JTIwZXF1aXBtZW50JTJDJTIwZW1waGFzaXppbmclMjBjdXR0aW5nLWVkZ2UlMjB0ZWNobm9sb2d5JTIwaW4lMjBhJTIwbWVkaWNhbCUyMHNldHRpbmcufGVufDB8fHx8MTc1NzU5NTI1Mnww&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Amrita Centre for Neurosciences offers
                                  world-class neurosurgical and spine care with
                                  cutting-edge technology and internationally
                              ...
                              <p>
                                  ...
                                  complex neurological surgeries with excellent
                                  outcomes.
                              </p>
                          </div>
                      </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919846123456?text=Hi, I'd like to book an appointment with ${doctor.name} for neurospine consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919846123456?text=Hi, I want to book an appointment for neurospine consultation at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919846123456?text=Hi, I need a cost estimate for neurospine surgery at Amrita Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
