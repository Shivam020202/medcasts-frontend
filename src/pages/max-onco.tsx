  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "523",
          image: "/images/max/small_Dr_Sandeep_Agarwal_c095cd0bfb.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "445",
          image: "/images/max/small_dr_pramod_kumar_julka_0b2eab5615.jpg",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "356",
          image: "/images/max/small_27_E06005_4d3dd25d5b.jpeg",
          qualifications:
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "298",
          image: "/images/max/dr_rajesh_kumar_jain_dcd39ec448.jpg",
      ...
      },
      {
          ...
          rating: "4.9",
          reviews: "267",
          image: "/images/max/Dr_Harit_Chaturvedi_new_0_5f2633c1ed.jpg",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Premier cancer care with cutting-edge
                                  technology, personalized treatment protocols,
                                  and world-class medical expertise.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1682663947127-ac9d59d7f312?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwb25jb2xvZ3klMjBlcXVpcG1lbnQlMkMlMjBsaWtlbHklMjBpbiUyMGElMjBtZWRpY2FsJTIwb3IlMjBob3NwaXRhbCUyMHNldHRpbmcufGVufDB8fHx8MTc1NzU5NTIzN3ww&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Max Cancer Centre is a premier comprehensive
                                  cancer care facility offering advanced
                                  surgical, medical, and radiation oncology
                                  services with world-class standards and
                                  personalized treatment approaches.
                              </p>
                              <p>
                                  Our expert team of oncologists and
                                  cutting-edge technology provide personalized
                                  treatment plans with exceptional patient
                                  outcomes and comprehensive support throughout
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "consultation" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          treatment planning with world-class
                                          expertise.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          targeted treatments with cutting-edge
                                          technology.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "recovery" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          rehabilitation programs with advanced
                                          monitoring systems.
                                      </div>
                                  )}
                              </div>
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/911129814444?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      ...
                                      complexity and treatment protocol
                                  </li>
                                  <li>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      World-class oncology specialists with
                                      proven expertise
                                  </p>
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/911129814444?text=Hi, I'd like to book an appointment with ${doctor.name} for oncology consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                                  ...
                                  <ul className="space-y-2 text-gray-700 text-sm">
                                      ...
                                      <li>
                                          • Bring all medical records, pathology
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911129814444?text=Hi, I want to book an appointment for oncology consultation at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911129814444?text=Hi, I need a cost estimate for cancer treatment at Max Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $260/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+911129814444", "_blank")
                                  }>
