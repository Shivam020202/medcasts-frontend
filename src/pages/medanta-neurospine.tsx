  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "420",
          image: "/images/medanta/manish.png",
      ...
      {
          name: "Dr. Karanjit Singh Narang",
          specialization: "Director, Neurosurgery",
          experience: "25+ years",
          patientsTreated: "10,000+",
          rating: "4.9",
          reviews: "380",
          image: "/images/medanta/Dr. Karanjit Singh Narang.png",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "310",
          image: "/images/medanta/dr-varindera-paul-singh.png",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "290",
          image: "/images/medanta/sudhir-dubey.png",
          qualifications:
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  World-class neurosurgical and spine care with
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Medanta - The Medicity Institute of
                                  Neurosciences offers world-class neurosurgical
                                  and spine care with cutting-edge technology
                                  and internationally trained specialists
                                  providing comprehensive treatment at
                                  affordable costs.
                              </p>
                              <p>
                                  Our department is equipped with the latest
                                  technology including intraoperative
                                  neuronavigation, neuromonitoring,
                                  intraoperative MRI, and robotic assistance,
                                  allowing our internationally trained
                                  specialists to perform both routine and
                                  complex neurological and spine surgeries with
                                  excellent outcomes.
                              </p>
                          </div>
                      </div>
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I want to book an appointment for neurospine consultation at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919811456789?text=Hi, I need a cost estimate for neurospine surgery at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $375/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
