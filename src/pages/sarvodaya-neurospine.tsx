  ...
  const doctors = [
      {
          ...
          rating: "4.8",
          reviews: "380",
          image: "/images/sarvodaya/Dr_Swarupa_a294d61429.jpg",
      ...
      },
      {
          ...
          rating: "4.8",
          reviews: "340",
          image: "/images/sarvodaya/DR_PUJA_KAPOOR_42082d084e.jpg",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "280",
          image: "/images/sarvodaya/DR_RAJENDER_SINGLA_987e824262.png",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "260",
          image: "/images/sarvodaya/Dr_Ritu_Jha_5df153993f.jpg",
          qualifications:
              "MBBS, MS, MCh (Neurosurgery), Fellowship in Functional Neurosurgery",
          expertise: [
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  Advanced neurosurgical and spine care with
                                  cutting-edge technology and experienced
                                  specialists at affordable costs.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1682663947127-ac9d59d7f312?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBbiUyMGltYWdlJTIwc2hvd2Nhc2luZyUyMGFkdmFuY2VkJTIwbmV1cm9zcGluZSUyMGVxdWlwbWVudCUyQyUyMGNyb3BwZWQlMjB0byUyMGZpdCUyMHRoZSUyMHNwZWNpZmllZCUyMGRpbWVuc2lvbnMufGVufDB8fHx8MTc1NzU5NTMwNnww&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Sarvodaya Hospital & Research Centre Institute
                                  of Neurosciences offers advanced neurosurgical
                                  and spine care with cutting-edge technology
                                  and experienced specialists providing
                                  comprehensive treatment at affordable costs.
                              </p>
                              <p>
                                  Our department is equipped with modern
                                  technology including neuronavigation,
                                  neuromonitoring, and robotic assistance,
                                  allowing our experienced specialists to
                                  perform both routine and complex neurological
                                  and spine surgeries with excellent outcomes.
                              </p>
                          </div>
                      </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          invasive and complex surgeries with
                                          modern technology.
                                      </div>
                                  )}
                              </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Advanced neurospine care with modern
                                      technology and experienced team
                                  </li>
                                  <li>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      Experienced neurospine specialists with
                                      proven expertise
                                  </p>
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for neurospine consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                                  ...
                                  <div className="text-amber-700 text-sm space-y-2">
                                      ...
                                      <p>
                                          • For surgeries beyond 30 days, 30%
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I want to book an appointment for neurospine consultation at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/919810123456?text=Hi, I need a cost estimate for neurospine surgery at Sarvodaya Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                                  🔥 <strong>9+ other people</strong> are
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $325/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                              ...
                              <div className="space-y-3">
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                      ...
                                      <span className="font-medium">
                                          neurospine@sarvodayahospital.com
                                      </span>
                                  </div>
                                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
