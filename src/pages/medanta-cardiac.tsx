  ...
  const doctors = [
      {
          ...
          rating: "4.9",
          reviews: "456",
          image: "/images/medanta/dr-naresh-trehan.png",
      ...
      },
      {
          ...
          rating: "4.7",
          reviews: "278",
          image: "/images/medanta/dr-anil-bhan.png",
                  ...
                  <div className="lg:col-span-3 space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
                          ...
                          <div className="mb-6">
                              ...
                              <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                                  India's leading cardiac care center with
                                  world-renowned surgeons, cutting-edge
                                  technology, and comprehensive heart
                                  treatments.
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              ...
                              <div className="grid grid-rows-2 gap-4">
                                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                                      <img
                                          src="https://images.unsplash.com/photo-1748722145009-6ba2d2c70559?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MTg3MTl8MHwxfHNlYXJjaHwxfHxBJTIwY3JvcHBlZCUyMGltYWdlJTIwb2YlMjBhJTIwZmFjZSUyQyUyMGxpa2VseSUyMGElMjBwb3J0cmFpdCUyQyUyMHdpdGglMjBhJTIwZm9jdXMlMjBvbiUyMHRoZSUyMGZhY2lhbCUyMGZlYXR1cmVzLnxlbnwwfHx8fDE3NTc1OTUxODd8MA&ixlib=rb-4.1.0&q=80&w=200$w=400"
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                          ...
                          <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                  Medanta - The Medicity is a premier
                                  multi-specialty medical institute in Gurugram,
                                  renowned for its world-class cardiac care. Our
                                  Heart Institute is equipped with
                                  state-of-the-art technology and advanced
                                  catheterization labs.
                              </p>
                              <p>
                                  Led by Dr. Naresh Trehan and our team of
                                  internationally trained cardiac specialists,
                                  we provide comprehensive heart treatments with
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "treatment" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          interventions with cutting-edge
                                          technology.
                                      </div>
                                  )}
                              </div>
                              ...
                              <div className="border border-gray-200 rounded-xl overflow-hidden">
                                  ...
                                  {expandedSection === "recovery" && (
                                      <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                                          ...
                                          programs with world-class monitoring
                                          systems.
                                      </div>
                                  )}
                              </div>
                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-6">
                              ...
                              {treatments.map((treatment, index) => (
                                  <div
                                      ...
                                      <button
                                          ...
                                          onClick={() =>
                                              window.open(
                                                  `https://wa.me/911244141414?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`,
                                                  "_blank"
                                              )
                                          }>
                                          Get Quote
                          ...
                          <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                              ...
                              <ul className="space-y-1 text-amber-700 text-sm">
                                  <li>
                                      • Premium cardiac care with world-class
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                              <div>
                                  ...
                                  <p className="text-gray-600">
                                      World-renowned cardiac specialists with
                                      proven expertise
                                  </p>
                              </div>
                                                  ...
                                                  .map((doctor, index) => (
                                                      <div
                                                          ...
                                                          <button
                                                              ...
                                                              onClick={() =>
                                                                  window.open(
                                                                      `https://wa.me/911244141414?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`,
                                                                      "_blank"
                                                                  )
                                                              }>
                                                              Book Appointment
                      ...
                      <div className="sticky top-8 space-y-6">
                          ...
                          <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                              ...
                              <div className="space-y-3 mb-5">
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911244141414?text=Hi, I want to book an appointment for cardiac consultation at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Book Consultation
                                  ...
                                  <button
                                      ...
                                      onClick={() =>
                                          window.open(
                                              "https://wa.me/911244141414?text=Hi, I need a cost estimate for cardiac treatment at Medanta Hospital.",
                                              "_blank"
                                          )
                                      }>
                                      Get Cost Estimate
                              ...
                              <div className="space-y-3 mb-5">
                                  ...
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                                      <div className="flex items-center text-sm text-teal-800">
                                          <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                                          <span className="font-medium">
                                              EMI options starting $280/month
                                          </span>
                                      </div>
                                  </div>
                                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                          ...
                          <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                              ...
                              <p className="text-sm text-red-700 mb-4 leading-relaxed">
                                  ...
                                  response team and world-class cardiac life
                                  support
                              </p>
                              <button
                                  ...
                                  onClick={() =>
                                      window.open("tel:+911244141414", "_blank")
                                  }>
